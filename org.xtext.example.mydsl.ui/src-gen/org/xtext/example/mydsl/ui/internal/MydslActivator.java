...
import org.xtext.example.mydsl.ui.MusicDslUiModule;
...
public class MydslActivator extends AbstractUIPlugin {
	...
	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MUSICDSL = "org.xtext.example.mydsl.MusicDsl";
	...
	protected com.google.inject.Module getRuntimeModule(String grammar) {
		if (ORG_XTEXT_EXAMPLE_MYDSL_MUSICDSL.equals(grammar)) {
	...
	protected com.google.inject.Module getUiModule(String grammar) {
		if (ORG_XTEXT_EXAMPLE_MYDSL_MUSICDSL.equals(grammar)) {
			return new MusicDslUiModule(this);
		}
		throw new IllegalArgumentException(grammar);
	}
