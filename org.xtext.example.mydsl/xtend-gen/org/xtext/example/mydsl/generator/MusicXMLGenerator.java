...
public class MusicXMLGenerator {
  ...
  public MusicXMLGenerator(final Composition composition) {
    this.composition = composition;
    this.minMeasureCount = this.minMeasureCount(composition);
  }
  
  public CharSequence generateMusicXml() {
    ...
    _builder.append("      ");
    _builder.append("<software>Flat</software>");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("</encoding>");
    _builder.newLine();
      ...
      for(final Integer measureCounter : _upTo) {
        ...
        _builder.newLineIfNotEmpty();
        {
          if (((measureCounter).intValue() == 0)) {
            ...
            _builder.newLine();
            _builder.append("  ");
            _builder.append("<divisions>2</divisions>");
            _builder.newLine();
            _builder.append("  ");
            _builder.append("<key>");
            _builder.newLine();
