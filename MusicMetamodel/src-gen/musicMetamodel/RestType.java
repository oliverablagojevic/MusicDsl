...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Rest Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see musicMetamodel.MusicMetamodelPackage#getRestType()
 * @model
 * @generated
 */
public enum RestType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Rest Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RestType[] VALUES_ARRAY = new RestType[] { WHOLE, HALF, QUARTER, EIGHTH, SIXTEENTH,
			THIRTYSECOND, SIXTYFOURTH, };

	/**
	 * A public read-only list of all the '<em><b>Rest Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RestType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Rest Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RestType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RestType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Rest Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static RestType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RestType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Rest Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RestType get(int value) {
		switch (value) {
		case WHOLE_VALUE:
			return WHOLE;
		case HALF_VALUE:
	 ...
	 * @generated
	 */
	private RestType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
